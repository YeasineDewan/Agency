...
import { FaMapMarkerAlt, FaClock, FaCheckCircle, FaUser, FaEnvelope, FaPhone, FaFileUpload, FaPaperPlane, FaVideo, FaImage } from 'react-icons/fa';

const ApplyContentCreator = () => {
  const { t } = useTranslation();
  const job = t('jobs.contentCreator', { returnObjects: true });
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all duration-200 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-rose-50 file:text-rose-700 hover:file:bg-rose-100"
                />
              </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-rose-600 to-pink-600 text-white py-4 px-6 rounded-lg font-semibold text-lg hover:from-rose-700 hover:to-pink-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {isSubmitting ? (
...
export default ApplyContentCreator;
