...
import { FaMapMarkerAlt, FaClock, FaCheckCircle, FaUser, FaEnvelope, FaPhone, FaFileUpload, FaPaperPlane, FaSearch } from 'react-icons/fa';

const ApplySEOAnalyst = () => {
  const { t } = useTranslation();
  const job = t('jobs.seoAnalyst', { returnObjects: true });
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-3">
                {job.responsibilities.map((resp, index) => (
                  ...
                  >
                    <FaCheckCircle className="text-orange-500 mt-1 mr-3 flex-shrink-0" />
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white py-4 px-6 rounded-lg font-semibold text-lg hover:from-orange-700 hover:to-red-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {isSubmitting ? (
...
export default ApplySEOAnalyst;
