...
import { FaCheck, FaCamera, FaMagic, FaRocket, FaGem, FaArrowLeft } from 'react-icons/fa';

const PhotoEditingDetails = () => {
  const [selectedTier, setSelectedTier] = useState('bronze-i');

  const pricingTiers = {
    'bronze-i': { name: 'Bronze I', price: 99, color: 'from-amber-600 to-amber-800' },
    'bronze-ii': { name: 'Bronze II', price: 149, color: 'from-amber-600 to-amber-800' },
    'bronze-iii': { name: 'Bronze III', price: 199, color: 'from-amber-600 to-amber-800' },
    'gold-i': { name: 'Gold I', price: 299, color: 'from-yellow-500 to-yellow-700' },
    'gold-ii': { name: 'Gold II', price: 399, color: 'from-yellow-500 to-yellow-700' },
    'gold-iii': { name: 'Gold III', price: 499, color: 'from-yellow-500 to-yellow-700' },
    'platinum-i': { name: 'Platinum I', price: 699, color: 'from-slate-400 to-slate-600' },
    'platinum-ii': { name: 'Platinum II', price: 899, color: 'from-slate-400 to-slate-600' },
    'platinum-iii': { name: 'Platinum III', price: 1099, color: 'from-slate-400 to-slate-600' },
    'diamond-i': { name: 'Diamond I', price: 1399, color: 'from-blue-400 to-blue-600' },
    'diamond-ii': { name: 'Diamond II', price: 1699, color: 'from-blue-400 to-blue-600' },
    'diamond-iii': { name: 'Diamond III', price: 1999, color: 'from-blue-400 to-blue-600' }
  };
  ...
  const tierFeatures = {
    ...
    'bronze-iii': [
      ...
      'Advanced background manipulation',
    ...
    'gold-i': [
      ...
      'Creative background replacement',
      'Multiple format outputs',
      'Skin retouching & enhancement',
      'Weekly progress updates',
      'Phone support'
    ],
    'gold-ii': [
      'Enterprise photo editing',
    ...
    'gold-iii': [
      ...
      'Complex compositing & manipulation',
    ...
    'platinum-i': [
      'Elite photo production suite',
      'Custom color science',
      'Advanced compositing & VFX',
      'AI-powered batch processing',
      'Celebrity-grade retouching',
    ...
    'platinum-iii': [
      ...
      'Blockbuster-grade color science',
      'Premium VFX capabilities',
    ...
    'diamond-i': [
      'Legendary photo studio',
      'Next-gen color technology',
      'AI-enhanced compositing',
      'Quantum processing optimization',
      'Iconic retouching standards',
      'Custom dashboard access',
      '24/7 creative director'
    ],
    'diamond-ii': [
      'Ultimate creative studio',
      'Revolutionary color science',
      'Neural compositing technology',
      'Advanced AI optimization',
      'Legendary retouching mastery',
      'Executive dashboard',
      'Chief creative officer access'
    ],
    'diamond-iii': [
      'Pinnacle photo empire',
      'Quantum color processing',
      'Holographic compositing',
      'Quantum AI optimization',
      'Mythical retouching perfection',
  ...
  const getTierIcon = (tier) => {
    if (tier.includes('bronze')) return <FaCamera className="text-amber-500" />;
    if (tier.includes('gold')) return <FaMagic className="text-yellow-500" />;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Photo Editing Services</h1>
                <p className="text-gray-600">Professional Photo Retouching & Enhancement</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <h2 className="text-2xl font-bold mb-6">Choose Your Editing Plan</h2>
              ...
              {['bronze', 'gold', 'platinum', 'diamond'].map((category) => (
                <div key={category} className="mb-8">
                  <h3 className={`text-xl font-semibold mb-4 capitalize flex items-center gap-2 ${
                    ...
                    {category === 'bronze' && <FaCamera />}
                    {category === 'gold' && <FaMagic />}
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-8">Why Choose Our Photo Editing Services?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-5xl mb-4">📸</div>
              <h3 className="text-xl font-semibold mb-2">Professional Quality</h3>
              <p className="text-gray-600">Magazine-quality retouching with attention to detail and natural-looking results</p>
            </div>
            <div className="text-center">
              <div className="text-5xl mb-4">⚡</div>
              <h3 className="text-xl font-semibold mb-2">Fast Turnaround</h3>
              <p className="text-gray-600">Quick delivery with multiple revision rounds to ensure your complete satisfaction</p>
            </div>
            <div className="text-center">
              <div className="text-5xl mb-4">🎨</div>
              <h3 className="text-xl font-semibold mb-2">Creative Excellence</h3>
              <p className="text-gray-600">Artistic vision combined with technical expertise for stunning visual results</p>
            </div>
          </div>
        </motion.div>
      </div>
...
export default PhotoEditingDetails;
